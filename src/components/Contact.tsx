                ...
                <div className="grid md:grid-cols-12 gap-6">
                    ...
                    <div className="md:col-span-7 grid sm:grid-cols-2 gap-6 reveal">
                        ...
                        >
                            ...
                            <p className="font-sans font-light text-2xl mt-3 tracking-tight text-ink-soft">
                                {WA_NUMBER}
                            </p>
                    ...
                    >
                        ...
                        <div className="mt-6 w-full max-w-[260px] aspect-square bg-white border border-line p-2 flex items-center justify-center">
                            <img
                                src={QR_IMG}
                                alt="QRIS PA Desa Putera"
